#!/bin/bash
# args[0] = controller ip, args[1] = jenkins pw, args[3] = username
...
# todo: username should come in as param
username=$3
...
# Retrieve the secret string and jar exec'n command
command=$(curl -u $username:$password $url/computer/TestingScriptName/ \
...
# jar command prefix
prefix="java -jar /home/$3/agent.jar -"
